...
module.exports = function UWAPrivacyPolygon() {
  ...
  function init() {
    startDrawing();
    options.points = [[219, 59], [80, 109], [96, 238], [190, 189]];
    addSvgDrawingObj(svgGeometry.draw(options));
    options.points = [[363, 81], [302, 133], [348, 217], [466, 160]];
    addSvgDrawingObj(svgGeometry.draw(options));
  }
...
module.exports = function UWAPrivacyRectangle() {
  ...
  var startDrawing = function startDrawing() {
    ...
    options.points = [[0, 0], [0, 100], [100, 100], [100, 0]];
...
var UWAPrivacyPolygon = require('./scripts/uwa_privacy_polygon.js');
var UWAPrivacyRectangle = require('./scripts/uwa_privacy_rectangle.js');
...
window.addEventListener('load', function () {
  ...
  wiseFDOptions.points = [[0, 0], [0, 480], [854, 480], [854, 0]];
  ...
  commonCalibrationOptions.points = [[0, 0], [0, 480], [854, 480], [854, 0]];
  ...
  commonCalibrationOptions.points = [[0, 0], [0, 100], [100, 100], [100, 0]];
