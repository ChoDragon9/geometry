function DrawView (draw, product) { // eslint-disable-line
      ...
      */
      ...
      if (draw.options.fixedRatio === true || draw.options.useRectangleForCustomDraw === true) {
        ...
        if (draw.options.useOnlyRectangle === true || draw.options.useRectangleForCustomDraw === true) {
          ...
          changedY1 = firstPoint[1]
          changedY2 = changedY1 + ((changedX2 - changedX1) * parentSvgRatio[1] / parentSvgRatio[0])
        ...
        drawView.changeRectangle(changedX1, changedY1, changedX2, changedY2)
